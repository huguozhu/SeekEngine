...
#define RESOURCE_FLAG_RENDER_TARGET         UINT64_C(0x0000000000000100)        // Render Target
#define RESOURCE_FLAG_SRV                   UINT64_C(0x0000000000010000)        // Shader Resource View
#define RESOURCE_FLAG_UAV                   UINT64_C(0x0000000000020000)        // Unordered Access View
...
#define RESOURCE_FLAG_APPEND                UINT64_C(0x0000000000100000)
#define RESOURCE_FLAG_COUNTER               UINT64_C(0x0000000000200000)


#define RESOURCE_FLAG_COPY_BACK             RESOURCE_FLAG_CPU_READ
