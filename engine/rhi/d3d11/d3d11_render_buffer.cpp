...
SResult D3D11RenderBuffer::Update(RHIRenderBufferData* buffer_data)
{
...
ID3D11ShaderResourceView * D3D11RenderBuffer::GetD3DSrv()
 {
...
ID3D11UnorderedAccessView* D3D11RenderBuffer::GetD3DUav()
{
...
SResult D3D11RenderBuffer::FillSrvDesc(D3D11_SHADER_RESOURCE_VIEW_DESC& desc)
{
...
SResult D3D11RenderBuffer::FillUavDesc(D3D11_UNORDERED_ACCESS_VIEW_DESC& desc)
{
