...
public:
    ...
    static D3D12_STENCIL_OP TranslateStencilOp(StencilOperation StencilOp);
    static D3D12_BLEND_OP TranslateBlendOp(BlendOperation BlendOp);
